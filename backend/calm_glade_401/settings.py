"""
Django settings for calm_glade_401 project.
...
ROOT_URLCONF = 'calm_glade_401.urls'
...
WSGI_APPLICATION = 'calm_glade_401.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "calm_glade_401 API",
    "DESCRIPTION": "API documentation for calm_glade_401 App",
    "VERSION": "v1",
}
